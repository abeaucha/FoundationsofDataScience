...
global_p1
ggsave(filename="./global_YearRatings.png",global_p1, width=wd, height=ht)
...
global_p3 <- ggplot(CapstoneDF, aes(x=YearMonth, y=Ratings, col=Year)) +
  ...
  mytheme + labs(x="Month") + theme(legend.position = "right", legend.justification = "bottom")+
  guides(col = guide_legend(override.aes = list(size=10)))
global_p3
ggsave(filename="./global_YearMonthRatings.png",global_p3, width=wd, height=ht)
...
names(t)[1] <- "Ratings"
global_p4 <- ggplot(CapstoneDF, aes(x=ceiling(Ratings))) + 
...
global_p4
ggsave(filename="./global_RatingsHist.png", global_p4, width=wd, height=ht)
...
global_p7
ggsave(filename="./global_RatingsYearHist_dens.png", global_p7, width=wd, height=ht)
...
wd=10.0
ht=10.0
global_p9 <- ggplot(temp, aes(x=Website, y=average, fill=Website)) + 
...
global_p9
ggsave(filename="./RatingsWebsiteMean.png", global_p9, width=wd, height=ht)
...
global_p10 <- ggplot(percentData, aes(x=Year, y=percentRatings, group=Ratings, col=Ratings)) + 
  ...
  theme(panel.grid.minor=element_blank(), 
        plot.margin = margin(10, 10, 10, 10)) +
  guides(col = guide_legend(override.aes = list(size=10)))
ggsave(filename="./global_percentRatings.png", global_p10, width=wd, height=ht)
