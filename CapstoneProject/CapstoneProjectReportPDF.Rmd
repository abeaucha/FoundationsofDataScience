---
title: "REDS Midtown Tavern Online Review Analytics (WORKING TITLE)"
...
An important first step \edit{Used "first step" earlier in here} towards the ultimate goal of analysing online customer review data is to scrape popular websites for the customer reviews. In this example, I will work with the first page of reviews for REDS Midtown Tavern on Yelp. Here is the relevant URL:  https://www.yelp.ca/biz/reds-midtown-tavern-toronto-2. The reviews are located not too far down the page. This is displayed in Figure \ref{REDSYelpRev}.

\begin{figure}[!ht]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{REDSYelpReviews.png}}
\caption{\edit{Add caption} \label{REDSYelpRev}}
\end{figure}
...
\caption{\edit{Add caption} \label{REDSYelpRev2}}
\end{figure}

\begin{figure}[!ht]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{REDSYelpReviews3.png}}
\caption{\edit{Add caption} \label{REDSYelpRev3}}
\end{figure}
...
An HTML file is comprised of different blocks of content, which are identified by their **type**. For example, in HTML, `<p>` represents a paragraph block, `<a>` a hyperlink, `<h1>` a heading, and so on. A screenshot of the HTML source file for  https://www.yelp.ca/biz/reds-midtown-tavern-toronto-2 is included in Figure \ref{REDSYelpHTML}. To learn more about HTML formatting, visit this website: https://www.w3schools.com/html/default.asp 


\begin{figure}[!ht]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{REDSYelpHTML.png}}
\caption{\edit{Add caption} \label{REDSYelpHTML}}
\end{figure}
