...
library(knitr)
opts_chunk$set(tidy=FALSE, message=FALSE, size="small")
```
...
# Arguments:
# LandingURL: URL for the landing page of the restaurant you want to scrape for. 
...
TripAdScrape <- function(LandingURL) {
  ...
  while(flag==1){
    ...
    #For subsequent iterations, grab hyperlink to the new page from the page links. 
...
\edit{Not sure what to do about these long URL strings}
...
BaseURL_Zomato <- 
  "https://www.zomato.com/toronto/reds-midtown-tavern-church-and-wellesley/reviews"
...
```
\ni This data is already is a workable format.  
